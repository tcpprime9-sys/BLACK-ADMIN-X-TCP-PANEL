...
def main():
    ...
    try:
        ...
        # bot.run()
        print("BLACK ADMIN X TCP Bot is starting safely...")
...
async def Room_Spam(Uid, Rm, Nm, K, V):
    ...
    fields = {
        ...
        2: {
            1: int(Rm),  
            2: "iG:[C][B][FF0000] —͞BLACK ADMIN Xᅠ",  
            3: {
                2: 1,
                3: 1
            },
...
🎯 Target: {target_uid}
🤖 Bot Name: —͞BLACK ADMIN Xᅠ
✅ Status: Ready to join

📱 Player will see:
"—͞BLACK ADMIN Xᅠ wants to join your team"
...
async def request_join_with_badge(target_uid, badge_value, key, iv, region):
    ...
    fields = {
        ...
        2: {
            ...
            6: "iG:[C][B][FF0000] —͞BLACK ADMIN Xᅠ",
            7: 330,
            8: 1000,
            10: region.upper(),
...
[FFDD00]━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━
[00FF00][b][c]BOT MADE BY BLACK ADMIN X GAMER
"""
        else:
...
[FFDD00]━━━━━━━━━━━━━━━━━━━━━━
[00FF00][b][c]⚡ BOT MADE BY BLACK ADMIN X
━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━"""
        else:
...
def send_likes(uid):
    try:
        likes_api_response = requests.get(
             f"https://like-api-mg24-pro.vercel.app/like?uid={uid}&server_name=bd",
             timeout=15
             )
...
[C][B][11EAFD]‎━━━━━━━━━━━━
[C][B][FFB300]Subscribe: [FFFFFF]LAM CODEX [00FF00]!!
"""
...
[00FFFF]██████╔╝░[FFFF00]██║░░██║[ff00ae]███████╗[FFA500]██║░╚═╝░██║[00FF00]██║░░██║[0600ff]██║░╚███║
[00FFFF]╚═════╝░░[FFFF00]╚═╝░░╚═╝[ff00ae]╚══════╝[FFA500]╚═╝░░░░░╚═╝[00FF00]╚═╝░░╚═╝[0600ff]╚═╝░░╚══╝
WOLCAM TO [FFFF00]BLACK ADMIN [FFA500]BOT [FFD700]THANKS [FFFF00]FOR YOU [00FF00]MESSAGE TO[FFFF00] /HELP AND [FFA500]COMMAND TO[FFFF00] ALL AND[FFFF00] INJOY YOU
ㅤㅤㅤㅤㅤ
ㅤㅤㅤㅤㅤ
ㅤㅤㅤㅤㅤ
ㅤㅤㅤㅤㅤ
              ...
              # =================== EMOTE DETECTION ONLY ===================
                ...
                if insquad == True:
                    try:
                        ...
                        message = """[[B][C][9B59B6]╔═══◆ WELCOME TO BLACK ADMIN X BOT ◆═══╗
[7F8C8D]╟──────────────────────────────╢
[FFFFFF]⚡ Powered By : [BB8FCE]BLACK ADMIN X
[FFFFFF]🎯 Status     : [2ECC71]ONLINE All time
[FFFFFF]📱 Contact    : [1ABC9C]tt [b][c]BLACK ADMIN X_
[7F8C8D]╟──────────────────────────────╢
...
📝 Examples:
/bio Hello World!
/bio 🤖 Bot by BLACK ADMIN X
/bio Level 70 | Pro Player
/bio Add me: BLACK ADMIN X
...
[FFFFFF]⚡ [00E5FF]mr.ghost34 💎
[AAAAAA]Thank you for your continued support
[00BFFF]╠════════════════════╣
[FFD700]⚡ Owner : [FFFFFF]BLACK ADMIN X
[00FF99]✨ To purchase a GUILD BOT,
[00FF99]please contact us on Telegram:
[FFFFFF]@BLACK_ADMIN_X 💎
[00BFFF]╚════════════════════╝
[CCCCCC]✨ Developed by —͟͞͞ </> [00E5FF]—͞BLACK ADMIN Xᅠ ❄️
"""
...
[FF6347]━[32CD32]━[7B68EE]━[FF4500]━[1E90FF]━[ADFF2F]━[FF69B4]━[8A2BE2]━[DC143C]━[FF8C00]━[BA55D3]━[7CFC00]━[FFC0CB]"""
                            ...
                            last ="""[B][C][FF0050]সাদিয়া,[FFFFFF]  
[C][00F2EA]তুমি আমার হৃদয়ের সবচেয়ে আপন মানুষ।  
[C][FFB703]তোমাকে ভালোবাসি শব্দে বোঝানো যায় না—  
[C][FF0050]তুমি আমার পৃথিবী। ❤️
"""
...
async def MaiiiinE():
    ...
    os.system('clear')
    print("=" * 50)
    print("🤖 —͞BLACK ADMIN Xᅠ BOT - INITIALIZING")
    print("=" * 50)
    ...
    os.system('clear')
    print("🤖 —͞BLACK ADMIN Xᅠ BOT - STARTING")
    print("=" * 50)
    ...
    os.system('clear')
    print("🤖 —͞BLACK ADMIN Xᅠ BOT - CONNECTING")
    print("=" * 50)
    print("┌────────────────────────────────────┐")
    print("│ ██████████████████████████████████ │")
    print("└────────────────────────────────────┘")
    ...
    os.system('clear')
    print("=" * 50)
    print("🤖 —͞BLACK ADMIN Xᅠ BOT - ONLINE")
    print("=" * 50)
    print(f"🔹 UID: {TarGeT}")
